...
def translate_file(data):
    lang = data.get('original_lang') + '-' + data.get('target_lang')

    input_file = open(data.get('input_file'), 'r', encoding='utf8')
    output_file = open(data.get('output_file'), 'w', encoding='utf8')
